...
import com.example.carreseller.adapter.MessagesAdapter;
import com.example.carreseller.models.MessagesModel;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receiverId = getIntent().getStringExtra("dealerId");
        receiverName = getIntent().getStringExtra("dealerName");
